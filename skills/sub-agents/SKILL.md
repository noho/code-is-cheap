...
| Codex | `codex-agent-run` | `ds-flash mimo mimo-fast mimo-flash qwen kimi glm glm-flash local hy gpt-6-astra gpt-6-sol gpt-6-luna business` | JSONL event stream |
